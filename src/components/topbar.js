...
const radioURLs = {
    tsr: "https://oreo.truckstopradio.co.uk/radio/8000/radio.mp3",
    tfm: "https://live.truckers.fm/",
    simhit: "https://radio.simulatorhits.com/radio/8000/stream",
};
const radioNames = {
    tsr: "TruckStopRadio",
    tfm: "TruckersFM",
    simhit: "SimulatorHits",
};
const radioImages = {
    tsr: "https://truckstopradio.co.uk/autodj.png",
    tfm: "https://truckersfm.s3.fr-par.scw.cloud/static/tfm-2020.png",
    simhit: "https://simulatorhits.com/images/SH_Logo.jpg",
};
const TopBar = (props) => {
        ...
        if (vars.userSettings.radio !== "disabled") {
            ...
            if (Object.keys(radioURLs).includes(vars.userSettings.radio_type)) {
                ...
                navigator.mediaSession.metadata = new MediaMetadata({
                    ...
                    artwork: [
                        {
                            src: radioImages[vars.userSettings.radio_type],
                            sizes: "256x256",
                            type: "image/jpeg",
                        },
                    ],
                ...
                try {
                    ...
                    // invalid url
                    console.error(tr("invalid_radio_url") + vars.userSettings.radio_type);
                }
            }
                ...
                try {
                    ...
                    if (vars.userSettings.radio_type === "tsr") {
                        let resp = await axios({
                            url: "https://tsr-static.omnibyte.tech/cache.php?url=https://panel.truckstopradio.co.uk/api/v1/song-history/now-playing",
                        });
                        ...
                        navigator.mediaSession.metadata = new MediaMetadata({
                            ...
                            artwork: vars.userSettings.data_saver
                                ...
                                : [
                                      {
                                          src: resp.data.song.graphic.medium,
                                          sizes: "300x300",
                                          type: "image/jpeg",
                                      },
                                  ],
                        ...
                        let resp = await axios({
                            url: "https://radiocloud.pro/api/public/v1/song/current",
                        });
                        ...
                        let resp = await axios({
                            url: "https://api.simulatorhits.com/now-playing",
                        });
                        setRadioSongName(resp.data.song.title);
    ...
    let loggedInBtns = (
        ...
        >
            {vars.userInfo.userid !== -1 && vars.userInfo.userid !== null && (
            ...
            >
                <AppBar
                    ...
                    sx={{
                        ...
                        width: {
                            sm: `calc(100% - ${props.sidebarWidth}px)`,
                        },
                        ml: {
                            sm: `${props.sidebarWidth}px`,
                        },
                        position: "fixed",
                        zIndex: "100",
                    }}
                                ...
                                {radioURL !== "" && (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                {isPlaying ? radioSongName : tr("radio_paused")}
                                            </div>
                                            <div
                                                className="user-role"
                                                style={{
