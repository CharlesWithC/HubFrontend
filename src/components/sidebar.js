...
const SideBar = (props) => {
    ...
    const menuName = useMemo(() => ({ "overview": tr("overview"), "statistics": "Statistics", "announcement": tr("announcements"), "downloads": tr("downloads"), "poll": tr("polls"), "gallery": tr("gallery"), "live_map": tr("map"), "delivery": tr("deliveries"), "challenge": tr("challenges"), "division": tr("divisions"), "economy": tr("economy"), "event": tr("events"), "member": tr("members"), "leaderboard": tr("leaderboard"), "ranking": tr("rankings"), "freightmaster": "FreightMaster™", "new_application": tr("new_application"), "my_application": tr("my_applications"), "all_application": tr("all_applications"), "member_list": tr("member_list"), "external_user": tr("external_users"), "audit_log": tr("audit_log"), "configuration": tr("configuration") }), []);
