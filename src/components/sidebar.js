...
const SideBar = (props) => {
    ...
    const pluginControl = useMemo(() => ({ "announcement": ["announcement"], "application": ["new_application", "my_application", "all_application"], "challenge": ["challenge"], "division": ["division", "division_pending"], "downloads": ["downloads"], "economy": ["economy"], "event": ["event"], "poll": ["poll"] }), []);
    ...
    const menu = useMemo(() => {
        ...
        if (curUID === null) {
            ...
            menu = [["overview", "statistics", "announcement", "downloads", "poll", "gallery"], ["live_map", "delivery", "challenge", "division", "division_pending", "event", "economy"], ["member", "leaderboard", "ranking", "freightmaster"], ["new_application", "my_application", "all_application"], ["member_list", "external_user", "audit_log", "configuration"]];
            if (!curUserPerm.includes("administrator")) {
                if (!curUserPerm.includes("driver") || curUser.userid === -1) {
                    toRemove = ["downloads", "challenge", "division", "division_pending", "economy", "poll", "member", "leaderboard", "ranking", "freightmaster", "external_user", "audit_log", "configuration"];
                }
