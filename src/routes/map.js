...
const Map = () => {
    ...
    return <Card>
        ...
        {tab === 1 && <TabPanel value={tab} index={1}>
            <TileMap tilesUrl={"https://map.charlws.com/ets2/promods/tiles"} title={<>{tr("euro_truck_simulator_2_promods_map")}<br />{tr("live_data_feed_truckersmp_eu_pm")}<span style={{ cursor: "pointer" }} onClick={handleToggleVtcOnly}>{orangeOnly ? tr("showing_vtc_drivers_only") : tr("showing_all_players")}&nbsp;{tr("click_to_toggle")}</span></>} points={points} onBoundaryChange={setBoundary} onPointClick={handlePointClick} showOrangeOnly={orangeOnly} />
        </TabPanel>}
        ...
        {tab === 3 && <TabPanel value={tab} index={3}>
            <TileMap tilesUrl={"https://map.charlws.com/ats/base/tiles"} title={<>{tr("american_truck_simulator_base_map")}<br />{tr("live_data_feed_truckersmp_us_sim")}<span style={{ cursor: "pointer" }} onClick={handleToggleVtcOnly}>{orangeOnly ? tr("showing_vtc_drivers_only") : tr("showing_all_players")}&nbsp;{tr("click_to_toggle")}</span></>} points={points} onBoundaryChange={setBoundary} onPointClick={handlePointClick} showOrangeOnly={orangeOnly} />
        </TabPanel>}
