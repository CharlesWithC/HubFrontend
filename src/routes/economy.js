...
const Economy = () => {
    ...
    useEffect(() => {
        if (modalGarageDetails !== null) setGarageOwner(modalGarageDetails.garage_owner);
    }, [modalGarageDetails]);
    ...
    useEffect(() => {
        if (dialogAction === "slot") setSlotPage(1);
    }, [dialogAction]);
    useEffect(() => {
        ...
        async function doLoad() {
            ...
            for (let i = 0; i < resp.data.list.length; i++) {
                ...
                let ctxMenu = (
                    <>
                        ...
                        <MenuItem
                            onClick={() => {
                                setActiveSlot(slot);
                                setDialogAction("sell-slot");
                            }}
                            sx={{ color: theme.palette.error.main }}
                            disabled={slot.note === "garage-owner"}>
                            {tr("sell_slot")}
                        </MenuItem>
                    </>
                );
                if (slot.truck !== null) {
                    newSlotList.push({
                        slotid: slot.slotid,
                        owner: <UserCard key={`${slotPage}-i`} user={slot.slot_owner} />,
                        truck: (
                            <a
                                className="hover-underline"
                                style={{ cursor: "pointer" }}
                                onClick={() => {
                                    setTruckReferer("slot");
                                    setActiveTruck(slot.truck);
                                    loadTruck(slot.truck);
                                    setDialogAction("truck");
                                }}>
                                {slot.truck.truck.brand} {slot.truck.truck.model}
                            </a>
                        ),
                        odometer: TSep(slot.truck.odometer),
                        income: TSep(slot.truck.income),
                        contextMenu: ctxMenu,
                    });
                } else {
                    newSlotList.push({
                        ...
                        truck: (
                            <a
                                ...
                                style={{ cursor: "pointer" }}
                                onClick={() => {
                                    setTruckSlotId(slot.slotid);
                                    setTruckReferer("slot");
                                    setDialogAction("purchase-truck");
                                }}>
                                {tr("empty_slot")}
                            </a>
                        ),
    ...
    useEffect(() => {
        setTruckOwner(activeTruck.owner);
        setTruckAssignee(activeTruck.assignee);
    }, [activeTruck]);
        ...
        async function doLoad() {
            ...
            for (let i = 0; i < resp.data.list.length; i++) {
                ...
                newTruckList.push({
                    ...
                    garage: economyCache.garagesMap[truck.garageid] !== undefined ? economyCache.garagesMap[truck.garageid].name : tr("unknown_garage"),
                    odometer: TSep(truck.odometer),
                    income: TSep(truck.income),
                    status: TRUCK_STATUS[truck.status],
                    data: truck,
                });
            }
    ...
    const updateBalanceVisibility = useCallback(
        async visibility => {
    ...
    const updateManageBalanceVisibility = useCallback(
        async visibility => {
    ...
    useEffect(() => {
        async function doLoad() {
            ...
            for (let i = 0; i < resp.data.list.length; i++) {
                let truck = resp.data.list[i];
                newTruckList.push({
                    model: truck.truck.brand + " " + truck.truck.model,
                    garage:
                        economyCache.garagesMap[truck.garageid] !== undefined ? (
                            <a
                                className="hover-underline"
                                style={{ cursor: "pointer" }}
                                onClick={e => {
                                    e.preventDefault();
                                    e.stopPropagation();
                                    setModalGarage(economyCache.garagesMap[truck.garageid]);
                                    setModalGarageDetails(null);
                                    handleGarageClick(economyCache.garagesMap[truck.garageid]);
                                    setDialogAction("garage");
                                }}>
                                {economyCache.garagesMap[truck.garageid].name}
                            </a>
                        ) : (
                            truck.garageid
                        ),
                    owner: <UserCard user={truck.owner} />,
                    income: TSep(truck.income),
                    data: truck,
                });
            }
            ...
            for (let i = 0; i < resp.data.list.length; i++) {
                ...
                let ctxMenu = (
                    <>
                        <MenuItem
                            onClick={() => {
                                setActiveMerch(merch);
                                setMerchOwner(merch.owner);
                                setDialogAction("transfer-merch");
                            }}
                            sx={{ color: theme.palette.warning.main }}>
                            {tr("transfer_merch")}
                        </MenuItem>
                ...
                <>
                    ...
                    <Dialog open={dialogAction === "garage"} onClose={() => setDialogAction("")} fullWidth>
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid size={4}>
                                            ...
                                            <Typography variant="body2">
                                                <UserCard user={modalGarageDetails.garage_owner} />
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                            ...
                                            <Typography variant="body2">
                                                <TimeDelta timestamp={modalGarageDetails.purchase_timestamp * 1000} />
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(modalGarageDetails.income)} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                ...
                                <>
                                    <Grid container spacing={2}>
                                        <Grid size={4}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(modalGarage.price)} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                        ...
                                        <Grid size={4}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(modalGarage.slot_price)} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                </>
                        ...
                        <DialogActions>
                            ...
                            {modalGarageDetails !== null && modalGarageDetails.garage_owner !== undefined && (
                                <>
                                    {(checkUserPerm(curUserPerm, ["administrator", "manage_economy", "manage_garage"]) || modalGarageDetails.garage_owner.userid === curUser.userid) && (
                                        <Button
                                            variant="contained"
                                            color="error"
                                            onClick={() => {
                                                setDialogAction("sell-garage");
                                            }}>
                                            {tr("sell")}
                                        </Button>
                                    )}
                                    {(checkUserPerm(curUserPerm, ["administrator", "manage_economy", "manage_garage"]) || modalGarageDetails.garage_owner.userid === curUser.userid) && (
                                        <Button
                                            ...
                                            color="warning"
                                            onClick={() => {
                                                setDialogAction("transfer-garage");
                                            }}>
                                            {tr("transfer")}
                                        </Button>
                                    )}
                    ...
                    {modalGarageDetails !== null && (
                        <>
                            <Dialog open={dialogAction === "transfer-garage"} onClose={() => setDialogAction("garage")} fullWidth>
                                <DialogTitle>
                                    <>{tr("transfer_garage")}</> - {modalGarage.name}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={12}>
                                            ...
                                            <Typography variant="body2">
                                                <UserSelect users={[garageOwner]} isMulti={false} includeCompany={true} onUpdate={setGarageOwner} />
                                            </Typography>
                                        </Grid>
                                        <Grid size={12}>
                                            <TextField label={tr("message")} value={message} onChange={e => setMessage(e.target.value)} fullWidth />
                                        </Grid>
                                    </Grid>
                                </DialogContent>
                                <DialogActions>
                            ...
                            <Dialog open={dialogAction === "sell-garage"} onClose={() => setDialogAction("garage")}>
                                <DialogTitle>
                                    <>{tr("sell_garage")}</> - {modalGarage.name}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={6}>
                                        ...
                                        <Grid size={6}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(parseInt(modalGarage.price * economyCache.config.garage_refund))} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                </DialogContent>
                            ...
                            <Dialog open={dialogAction === "slot"} onClose={() => setDialogAction("garage")} fullWidth>
                                ...
                                <DialogActions>
                                    ...
                                    <Button
                                        ...
                                        disabled={dialogDisabled}>
                                        <>{tr("purchase")}</> (<>{tr("cost")}</>: {modalGarage.slot_price})
                                    </Button>
                                </DialogActions>
                            </Dialog>
                            <Dialog open={dialogAction === "transfer-slot"} onClose={() => setDialogAction("slot")} fullWidth>
                                <DialogTitle>
                                    <>{tr("transfer_slot")}</> #{activeSlot.slotid} - {modalGarage.name}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={12}>
                                            ...
                                            <Typography variant="body2">
                                                <UserSelect users={[slotOwner]} isMulti={false} includeCompany={true} onUpdate={setSlotOwner} />
                                            </Typography>
                                        </Grid>
                                        <Grid size={12}>
                                            <TextField label={tr("message")} value={message} onChange={e => setMessage(e.target.value)} fullWidth />
                            ...
                            <Dialog open={dialogAction === "sell-slot"} onClose={() => setDialogAction("slot")}>
                                <DialogTitle>
                                    <>{tr("sell_slot")}</> #{activeSlot.slotid} - {modalGarage.name}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={6}>
                                        ...
                                        <Grid size={6}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(parseInt(modalGarage.slot_price * economyCache.config.slot_refund))} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                </DialogContent>
                    ...
                    {activeTruck.truck !== undefined && (
                        <>
                            <Dialog open={dialogAction === "truck"} onClose={() => setDialogAction(truckReferer)}>
                                <DialogTitle>
                                    <>{tr("vehicle")}</> #{activeTruck.vehicleid}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={4}>
                                            ...
                                            <Typography variant="body2">
                                                <UserCard user={activeTruck.owner} />
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                        ...
                                        <Grid size={4}>
                                            ...
                                            <Typography variant="body2">
                                                {activeTruck.truck.brand} {activeTruck.truck.model}
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(activeTruck.price)} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                            ...
                                            <Typography variant="body2">
                                                <TimeDelta timestamp={activeTruck.purchase_timestamp * 1000} />
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                        ...
                                        <Grid size={4}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(activeTruck.income)} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(activeTruck.service)} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                        ...
                                        <Grid size={4}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(activeTruck.repair_cost)} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                        <Grid size={4}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                        ...
                                        <>
                                            <ButtonGroup fullWidth sx={{ mt: "10px" }}>
                                                <Button
                                                    ...
                                                    disabled={activeTruck.status !== "inactive" || dialogDisabled}>
                                                    {tr("activate")}
                                                </Button>
                                                <Button
                                                    variant="contained"
                                                    ...
                                                    disabled={activeTruck.status !== "active" || dialogDisabled}>
                                                    {tr("deactivate")}
                                                </Button>
                                                <Button
                                                    variant="contained"
                                                    color="info"
                                                    onClick={() => {
                                                        setDialogAction("relocate-truck");
                                                    }}
                                                    disabled={dialogDisabled}>
                                                    {tr("relocate")}
                                                </Button>
                                                <Button
                                                    ...
                                                    disabled={activeTruck.damage === 0 || dialogDisabled}>
                                                    {tr("repair")}
                                                </Button>
                                            </ButtonGroup>
                                            <ButtonGroup fullWidth sx={{ mt: "10px" }}>
                                                <Button
                                                    ...
                                                    color="warning"
                                                    onClick={() => {
                                                        setDialogAction("transfer-truck");
                                                    }}
                                                    disabled={dialogDisabled}>
                                                    {tr("transfer")}
                                                </Button>
                                                <Button
                                                    ...
                                                    color="warning"
                                                    onClick={() => {
                                                        setDialogAction("reassign-truck");
                                                    }}
                                                    disabled={activeTruck.owner.userid !== null || dialogDisabled}>
                                                    {tr("reassign")}
                                                </Button>
                                                <Button
                                                    variant="contained"
                            ...
                            <Dialog open={dialogAction === "relocate-truck"} onClose={() => setDialogAction("truck")} fullWidth>
                                <DialogTitle>
                                    <>{tr("relocate_truck")}</> #{activeTruck.vehicleid} - {activeTruck.truck.brand} {activeTruck.truck.model}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={12}>
                                            <TextField label={tr("slot_id")} value={truckSlotId} onChange={e => setTruckSlotId(e.target.value)} fullWidth sx={{ mt: "5px" }} />
                                        </Grid>
                                    </Grid>
                                </DialogContent>
                                <DialogActions>
                            ...
                            <Dialog open={dialogAction === "transfer-truck"} onClose={() => setDialogAction("truck")} fullWidth>
                                <DialogTitle>
                                    <>{tr("transfer_truck")}</> #{activeTruck.vehicleid} - {activeTruck.truck.brand} {activeTruck.truck.model}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={12}>
                                            ...
                                            <Typography variant="body2">
                                                <UserSelect users={[truckOwner]} isMulti={false} includeCompany={true} onUpdate={setTruckOwner} />
                                            </Typography>
                                        </Grid>
                                        <Grid size={12}>
                                            <TextField label={tr("message")} value={message} onChange={e => setMessage(e.target.value)} fullWidth />
                            ...
                            <Dialog open={dialogAction === "reassign-truck"} onClose={() => setDialogAction("truck")} fullWidth>
                                <DialogTitle>
                                    <>{tr("reassign_truck")}</> #{activeTruck.vehicleid} - {activeTruck.truck.brand} {activeTruck.truck.model}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={12}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                                {tr("new_truck_assignee")}
                                            </Typography>
                                            <Typography variant="body2">
                                                <UserSelect users={[truckAssignee]} isMulti={false} includeCompany={true} onUpdate={setTruckAssignee} />
                                            </Typography>
                                        </Grid>
                                        <Grid size={12}>
                                            <TextField label={tr("message")} value={message} onChange={e => setMessage(e.target.value)} fullWidth />
                            ...
                            <Dialog open={dialogAction === "sell-truck"} onClose={() => setDialogAction("truck")}>
                                <DialogTitle>
                                    <>{tr("sell_truck")}</> #{activeTruck.vehicleid} - {activeTruck.truck.brand} {activeTruck.truck.model}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={6}>
                                        ...
                                        <Grid size={6}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(parseInt(activeTruck.price * economyCache.config.truck_refund))} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                </DialogContent>
                            ...
                            <Dialog open={dialogAction === "scrap-truck"} onClose={() => setDialogAction("truck")}>
                                <DialogTitle>
                                    <>{tr("scrap_truck")}</> #{activeTruck.vehicleid} - {activeTruck.truck.brand} {activeTruck.truck.model}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={6}>
                                        ...
                                        <Grid size={6}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(parseInt(activeTruck.price * economyCache.config.scrap_refund))} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                </DialogContent>
                    ...
                    <Dialog open={dialogAction === "purchase-truck"} onClose={() => setDialogAction(truckReferer)} fullWidth>
                        ...
                        <DialogActions>
                            ...
                            <Button
                                ...
                                disabled={selectedTruck.truck === undefined || truckSlotId === "" || dialogDisabled}>
                                {tr("purchase")}
                            </Button>
                        </DialogActions>
                    </Dialog>
                    <Dialog open={dialogAction === "manage-balance"} onClose={() => setDialogAction("")} fullWidth>
                        ...
                        <DialogContent>
                            ...
                            <Typography variant="body2">
                                <UserSelect users={[manageTransferFrom]} isMulti={false} includeCompany={true} onUpdate={setManageTransferFrom} />
                            </Typography>
                            <br />
                            <Typography variant="body">
                                {tr("current_balance")}: {TSep(manageBalance)} {economyCache.config.currency_name}
                                {manageBalanceVisibility === "public" && (
                                    <IconButton
                                        onClick={() => {
                                            updateManageBalanceVisibility("private");
                                        }}>
                                        <FontAwesomeIcon icon={faUnlock} />
                                    </IconButton>
                                )}
                                {manageBalanceVisibility === "private" && (
                                    <IconButton
                                        onClick={() => {
                                            updateManageBalanceVisibility("public");
                                        }}>
                            ...
                            <Grid container spacing={2} sx={{ mt: "5px" }}>
                                <Grid
                                    ...
                                    <TextField label={tr("set_balance_to")} value={manageNewBalance} onChange={e => setManageNewBalance(e.target.value)} fullWidth size="small" />
                                </Grid>
                                <Grid
                                    size={{
                                        xs: 12,
                            ...
                            <Typography variant="h6" sx={{ fontWeight: 800, mb: "10px" }}>
                            ...
                            <Grid container spacing={2}>
                                <Grid
                                    ...
                                    <Typography variant="body2">
                                        <UserSelect users={[manageTransferTo]} isMulti={false} includeCompany={true} includeBlackhole={true} onUpdate={setManageTransferTo} />
                                    </Typography>
                                </Grid>
                                <Grid
                                    size={{
                                    ...
                                    <TextField label={tr("amount")} value={manageTransferAmount} onChange={e => setManageTransferAmount(e.target.value)} fullWidth size="small" sx={{ mt: { md: "18px", lg: "18px" } }} />
                                </Grid>
                                <Grid size={12}>
                                    <TextField label={tr("message")} value={manageTransferMessage} onChange={e => setManageTransferMessage(e.target.value)} fullWidth />
                                </Grid>
                            </Grid>
                        </DialogContent>
                        <DialogActions>
                    ...
                    {activeMerch.merchid !== undefined && (
                        <>
                            <Dialog open={dialogAction === "transfer-merch"} onClose={() => setDialogAction("merch")} fullWidth>
                                <DialogTitle>
                                    <>{tr("transfer_merch")}</> - {economyCache.merchMap[activeMerch.merchid] !== undefined ? economyCache.merchMap[activeMerch.merchid].name : activeMerch.merchid}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={12}>
                                            ...
                                            <Typography variant="body2">
                                                <UserSelect users={[merchOwner]} isMulti={false} includeCompany={true} onUpdate={setMerchOwner} />
                                            </Typography>
                                        </Grid>
                                        <Grid size={12}>
                                            <TextField label={tr("message")} value={message} onChange={e => setMessage(e.target.value)} fullWidth />
                            ...
                            <Dialog open={dialogAction === "sell-merch"} onClose={() => setDialogAction("merch")}>
                                <DialogTitle>
                                    <>{tr("sell_merch")}</> - {economyCache.merchMap[activeMerch.merchid] !== undefined ? economyCache.merchMap[activeMerch.merchid].name : activeMerch.merchid}
                                </DialogTitle>
                                <DialogContent>
                                    <Grid container spacing={2}>
                                        <Grid size={6}>
                                            ...
                                            <Typography variant="body2">
                                                {TSep(activeMerch.price)} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                        <Grid size={6}>
                                            <Typography variant="body2" sx={{ fontWeight: "bold" }}>
                                            ...
                                            <Typography variant="body2">
                                                {economyCache.merchMap[activeMerch.merchid] !== undefined ? TSep(economyCache.merchMap[activeMerch.merchid].sell_price) : "/"} {economyCache.config.currency_name}
                                            </Typography>
                                        </Grid>
                                    </Grid>
                                </DialogContent>
                    ...
                    <Dialog open={dialogAction === "purchase-merch"} onClose={() => setDialogAction("")} fullWidth>
                        ...
                        <DialogActions>
                            ...
                            <Button
                                ...
                                disabled={selectedMerch.value === undefined || dialogDisabled}>
                                {tr("purchase")}
                            </Button>
                        </DialogActions>
                    </Dialog>
                    <Grid container spacing={2} sx={{ mt: "10px" }}>
                            ...
                            <CustomTable
                                name={
                                    <>
                                        ...
                                        &nbsp;&nbsp;{tr("balance_leaderboard")}
                                    </>
                                }
                                columns={leaderboardColumns}
                                data={leaderboard}
                                totalItems={leaderboardTotal}
                                rowsPerPageOptions={[5, 10, 25, 50]}
                                page={leaderboardPage}
                                defaultRowsPerPage={leaderboardPageSize}
                                onPageChange={setLeaderboardPage}
                                onRowsPerPageChange={setLeaderboardPageSize}
                                onRowClick={
                                    checkUserPerm(curUserPerm, ["administrator", "manage_economy", "manage_balance"])
                                        ? row => {
                                              setManageTransferFrom(row.data);
                                              setManageBalance(row.balance);
                                              setDialogAction("manage-balance");
                                          }
                                        : undefined
                                }
                            />
                            ...
                            <Card>
                                <CardContent>
                                    <div style={{ display: "flex", alignItems: "center" }}>
                                        <Typography variant="h6" sx={{ fontWeight: 800, mb: "10px", display: "flex", alignItems: "center", marginRight: "auto" }}>
                                            <FontAwesomeIcon icon={faCoins} />
                                            &nbsp;&nbsp;{tr("balance")}
                                        </Typography>
                                        <Typography variant="h6" component="div" style={{ display: "flex", alignItems: "center" }}>
                                            {balanceVisibility === "public" && (
                                                <IconButton
                                                    onClick={() => {
                                                        updateBalanceVisibility("private");
                                                    }}>
                                                    <FontAwesomeIcon icon={faUnlock} />
                                                </IconButton>
                                            )}
                                            {balanceVisibility === "private" && (
                                                <IconButton
                                                    onClick={() => {
                                                        updateBalanceVisibility("public");
                                                    }}>
                                                    <FontAwesomeIcon icon={faLock} />
                                                </IconButton>
                                            )}
                                            ...
                                            )}
                                            {
                                                <IconButton
                                                    onClick={() => {
                                                        setDialogAction("export-transaction");
                                                    }}>
                                    ...
                                    <Typography variant="body">
                                        {tr("current_balance")}: {TSep(balance)} {economyCache.config.currency_name}
                                    </Typography>
                                    <Divider sx={{ mt: "10px", mb: "10px" }} />
                                    <Typography variant="h6" sx={{ fontWeight: 800, mb: "10px" }}>
                                        <FontAwesomeIcon icon={faMoneyBillTransfer} />
                                    ...
                                    <Grid container spacing={2}>
                                        <Grid
                                            ...
                                            <Typography variant="body2">
                                                <UserSelect users={[transferTo]} isMulti={false} includeCompany={true} onUpdate={setTransferTo} />
                                            </Typography>
                                        </Grid>
                                        <Grid
                                            size={{
                                            ...
                                            <TextField label={tr("amount")} value={transferAmount} onChange={e => setTransferAmount(e.target.value)} fullWidth size="small" sx={{ mt: { md: "18px", lg: "18px" } }} />
                                        </Grid>
                                        <Grid size={12}>
                                            <TextField label={tr("message")} value={transferMessage} onChange={e => setTransferMessage(e.target.value)} fullWidth />
                                        </Grid>
                                    </Grid>
                                    <Button
                                        variant="contained"
                                        ...
                                        disabled={transferTo.userid === undefined || dialogDisabled}
                                        sx={{ mt: "10px" }}>
                                        {tr("transfer")}
                                    </Button>
                                </CardContent>
                        ...
                        <Grid
                            ...
                            <CustomTable
                                ...
                                data={garageList}
                                totalItems={garageTotal}
                                rowsPerPageOptions={[5, 10, 25, 50]}
                                page={garagePage}
                                defaultRowsPerPage={garagePageSize}
                                onPageChange={setGaragePage}
                                onRowsPerPageChange={setGaragePageSize}
                                onRowClick={row => {
                                    if (economyCache.garagesMap[row.data.garageid] !== undefined) {
                                        setModalGarage(economyCache.garagesMap[row.data.garageid]);
                                    }
                                    setModalGarageDetails(row.data);
                                    setDialogAction("garage");
                                }}
                            />
                        </Grid>
                        <Grid
                            ...
                            <CustomTable
                                ...
                                data={truckList}
                                totalItems={truckTotal}
                                rowsPerPageOptions={[5, 10, 25, 50]}
                                page={truckPage}
                                defaultRowsPerPage={truckPageSize}
                                onPageChange={setTruckPage}
                                onRowsPerPageChange={setTruckPageSize}
                                onRowClick={row => {
                                    setTruckReferer("");
                                    setActiveTruck(row.data);
                                    loadTruck(row.data);
                                    setDialogAction("truck");
                                }}
                            />
                        ...
                        <Grid
                            ...
                            <CustomTable
                                ...
                                columns={myTruckColumns}
                                data={myTruckList}
                                totalItems={myTruckTotal}
                                rowsPerPageOptions={[5, 10, 25, 50]}
                                page={myTruckPage}
                                defaultRowsPerPage={myTruckPageSize}
                                onPageChange={setMyTruckPage}
                                onRowsPerPageChange={setMyTruckPageSize}
                                onRowClick={row => {
                                    setTruckReferer("");
                                    setActiveTruck(row.data);
                                    loadTruck(row.data);
                            ...
                            <CustomTable
                                name={
                                    <>
                                        ...
                                        &nbsp;&nbsp;{tr("owned_merchandise")}
                                    </>
                                }
                                nameRight={
                                    <IconButton
                                        onClick={() => {
                                            setDialogAction("purchase-merch");
                                        }}>
                                        <FontAwesomeIcon icon={faPlus} />
                                    </IconButton>
                                }
                                ...
                                data={merchList}
                                totalItems={merchTotal}
                                rowsPerPageOptions={[5, 10, 25, 50]}
                                page={merchPage}
                                defaultRowsPerPage={merchPageSize}
                                onPageChange={setMerchPage}
                                onRowsPerPageChange={setMerchPageSize}
                            />
                        </Grid>
                    </Grid>
                    <Portal>
