...
function App() {
    ...
    const hasSpeedDial =
        ["/announcement", "/challenge", "/delivery", "/division", "/downloads", "/event", "/leaderboard", "/poll", "/ranking", "/member-list", "/external-user"].includes(location.pathname) ||
                    ...
                    <div
                        style={
                            (!sidebarHidden && {
                                position: "relative",
                                left: "260px",
                                top: !topbarHidden ? "80px" : "0",
                                width: "calc(100vw - 260px)",
                                height: !topbarHidden ? "calc(100vh - 80px)" : "100vh",
                                overflow: "hidden",
                            }) ||
                            (sidebarHidden && {
                                position: "relative",
                            ...
                            <>
                                <Card
                                    sx={{
                                        ...
                                        bottom: "10px",
                                        right: "10px",
                                        width: window.innerWidth <= 420 ? "calc(100vw - 20px) !important" : "400px",
                                    }}
                                >
                                    <CardContent>
                        ...
                        >
                            ...
                            >
                                <Routes>
                                    ...
                                    {vars.discordClientID !== 1120997206938361877 && (
                                        <Route
                                            path="/auth/discord/redirect"
                                            element={
                                                <Redirect
                                                    to={`https://discord.com/oauth2/authorize?client_id=${vars.discordClientID}&redirect_uri=${protocol}%3A%2F%2F${window.location.host}%2Fauth%2Fdiscord%2Fcallback&response_type=code&scope=identify email role_connections.write`}
                                                />
                                            }
                                        />
                                    )}
                                    {vars.discordClientID === 1120997206938361877 && (
                                        <Route path="/auth/discord/redirect" element={<Redirect to={`https://oauth.chub.page/discord-auth?domain=${window.location.host}`} />} />
                                    )}
                                ...
                                <Dialog open={aboutCHubModal} onClose={() => setAboutCHubModal(false)}>
                                    ...
                                    <DialogContent>
                                        <Typography variant="body2">
                                            Embark on a journey through the digital thoroughfares with <b>Drivers Hub</b>, an ethereal portal for Virtual Trucking Communities, crafted to elevate
                                        ...
                                        <Typography variant="body2">
                                            ...
                                            &nbsp;&nbsp;
                                            <a href="https://truckstopradio.co.uk/" target="_blank" rel="noreferrer">
                                                TruckStopRadio
                                            </a>
                                            &nbsp;&nbsp;
                                            ...
                                            &nbsp;&nbsp;
                                            <a href="https://ocsc-event.com/" target="_blank" rel="noreferrer">
                                                OCSC Event
                                            </a>
                                            &nbsp;&nbsp;
                                        </Typography>
                                        ...
                                        >
                                            ...
                                            <Typography
                                                ...
                                                sx={{
                                                    ...
                                                    textAlign: "right",
                                                    fontWeight: 800,
                                                    marginRight: hasSpeedDial ? "70px" : 0,
                                                }}
                                            >
                                                {vars.dhconfig.name}
                                                <br />
                                                {tr("server")}:&nbsp;
                                                <span>v{vars.apiversion}</span>
                                                | {tr("client")}:&nbsp;
                                                <span>v3.2.0</span>
                                            </Typography>
                                        </div>
