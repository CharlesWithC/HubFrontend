...
async function loadChart(userid = -1) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/dlog/chart?scale=" + chartscale + "&addup=" + addup + "&quserid=" + userid,
        type: "GET",
        dataType: "json",
        headers: {
...
function loadStats(basic = false) {
    ...
    loadChart();
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/dlog/stats",
        type: "GET",
        dataType: "json",
        success: function (data) {
            d = data.response;
    ...
    if (!basic) {
        $.ajax({
            url: "https://drivershub10.charlws.com/" + vtcprefix + "/dlog/leaderboard",
            type: "GET",
            dataType: "json",
            headers: {
        ...
        $.ajax({
            url: "https://drivershub10.charlws.com/" + vtcprefix + "/dlog/newdrivers",
            type: "GET",
            dataType: "json",
            headers: {
                "Authorization": "Bearer " + token
...
function loadDownloads() {
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/downloads",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function FetchAnnouncement() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/announcement?aid=" + aid,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function NewAnn() {
    ...
    if (op == "update") {
        ...
        $.ajax({
            url: "https://drivershub10.charlws.com/" + vtcprefix + "/announcement",
            type: "PATCH",
            dataType: "json",
            headers: {
                "Authorization": "Bearer " + token
        ...
        annid = parseInt(annid);
        $.ajax({
            url: "https://drivershub10.charlws.com/" + vtcprefix + "/announcement?aid=" + annid,
            type: "DELETE",
            dataType: "json",
            headers: {
                "Authorization": "Bearer " + token
...
function FetchEvent(showdetail = -1) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/event?eventid=" + eventid,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function UpdateEventAttendees() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/event/attendee",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function NewEvent() {
    ...
    if (op == "update") {
        ...
        $.ajax({
            url: "https://drivershub10.charlws.com/" + vtcprefix + "/event",
            type: "PATCH",
            dataType: "json",
            headers: {
                "Authorization": "Bearer " + token
...
function SubmitApp() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/application",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + token
...
function validate() {
    ...
    $("#recruitment").show();
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/user/validate",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + token
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/user/info",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + token
        ...
        success: function (data) {
            if (data.error == false) {
                ...
                if (rolesLastUpdate == null || rolesLastUpdate == undefined || parseInt(rolesLastUpdate) < (+new Date() - 86400)) {
                    $.ajax({
                        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/roles",
                        type: "GET",
                        dataType: "json",
                        success: function (data) {
...
<label for="role` + roleids[i] + `">` + rolelist[roleids[i]] + `</label></li>`);
                ...
                if (userid != -1) {
                    $.ajax({
                        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/info?userid=" + userid,
                        type: "GET",
                        dataType: "json",
                        headers: {
                            "Authorization": "Bearer " + token
...
function loadLeaderboard(recurse = true) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/dlog/leaderboard?page=" + page + "&speedlimit=" + parseInt(speedlimit) + "&starttime=" + starttime + "&endtime=" + endtime + "&game=" + game + "&noevent=" + (1 - levent) + "&nodivision=" + (1 - ldivision),
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function requestRole() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/discordrole",
        type: "PATCH",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function loadDelivery(recurse = true) {
    ...
    if (!dets2 && !dats) starttime = 1, endtime = 2;
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/dlog/list?page=" + page + "&speedlimit=" + parseInt(speedlimit) + "&starttime=" + starttime + "&endtime=" + endtime + "&game=" + game,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function loadDivision() {
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/division/info",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function loadStaffDivision() {
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/division/validate",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function deliveryDetail(logid) {
    ...
    $("#rrplay").html("Play");
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/dlog/detail?logid=" + String(logid),
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function divisionInfo(logid) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/division/info?logid=" + logid,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function loadEvent(recurse = true) {
    ...
    if (eventsCalendar == undefined) {
        $.ajax({
            url: "https://drivershub10.charlws.com/" + vtcprefix + "/event/full",
            type: "GET",
            dataType: "json",
            headers: {
                "Authorization": "Bearer " + localStorage.getItem("token")
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/event?page=" + page,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function eventvote(eventid) {
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/event/vote",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function loadMembers(recurse = true) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/list?page=" + page + "&search=" + $("#searchname").val(),
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
        ...
        success: function (data) {
            ...
            for (i = 0; i < users.length; i++) {
                ...
                if (highestrole <= 9) color = "#3498CF"; // Leadership
...
function loadAuditLog(recurse = true) {
    ...
    if (page == undefined) page = 1;
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/auditlog?page=" + page,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function memberDetail(userid) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/info?userid=" + String(userid),
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function fetchRoles() {
    ...
    $("#memberrolename").html("");
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/list?page=1&search=" + val,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
        ...
        success: function (data) {
            ...
            $.ajax({
                url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/info?userid=" + String(lastfetch),
                type: "GET",
                dataType: "json",
                headers: {
                    "Authorization": "Bearer " + localStorage.getItem("token")
...
function updateMemberRoles() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/role",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function updateMemberPoints() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/point",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function dismissUser() {
    ...
    $("#dismissbtn").attr("disabled", "disabled");
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/dismiss?userid=" + String(userid),
        type: "DELETE",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function loadUserDelivery(recurse = true) {
    ...
    if (!dets2 && !dats) starttime = 1, endtime = 2;
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/dlog/list?quserid=" + curprofile + "&speedlimit=" + parseInt(speedlimit) + "&page=" + page + "&starttime=" + starttime + "&endtime=" + endtime + "&game=" + game,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
        ...
        success: async function (data) {
            ...
            if (!data.error) {
                ...
                for (var i = 0; i < roles.length; i++) {
                    ...
                    else if (roles[i] < 10) color = "#3498CF";
                    else if (roles[i] <= 98) color = "#ff0000";
                    else if (roles[i] == 99) color = "#4e6f7b";
                    else if (roles[i] == 100) color = "#3498CF";
...
function updateBio() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/user/bio",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function genNewAppToken() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/user/apptoken",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function resign() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/resign",
        type: "DELETE",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function loadUsers(recurse = true) {
    ...
    if (page == undefined) page = 1;
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/user/list?page=" + page,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function addUser(discordid = -1) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/member/add",
        type: "POSt",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function userDetail(discordid) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/user/info?qdiscordid=" + String(discordid),
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function banUser() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/user/ban",
        type: "POSt",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function unbanUser() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/user/unban",
        type: "POSt",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function loadMyApp(recurse = true) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/application/list?page=" + page + "&apptype=0",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function loadAllApp(recurse = true) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/application/list?page=" + page + "&apptype=0&showall=1",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function appDetail(applicationid, staffmode = false) {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/application?applicationid=" + applicationid,
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function updateAppStatus() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/application/status",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
function updateStaffPosition() {
    ...
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/application/positions",
        type: "POST",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + localStorage.getItem("token")
...
$(document).ready(function () {
    ...
    $("#logout").click(function () {
        token = localStorage.getItem("token")
        $.ajax({
            url: "https://drivershub10.charlws.com/" + vtcprefix + "/user/revoke",
            type: "POST",
            dataType: "json",
            headers: {
                "Authorization": "Bearer " + token
    ...
    annpage = 2;
    $.ajax({
        url: "https://drivershub10.charlws.com/" + vtcprefix + "/announcement?page=1",
        type: "GET",
        dataType: "json",
        headers: {
            "Authorization": "Bearer " + token
    ...
    window.onscroll = function (ev) {
        ...
        if ((window.innerHeight + window.scrollY + 100) >= document.body.offsetHeight) {
            $.ajax({
                url: "https://drivershub10.charlws.com/" + vtcprefix + "/announcement?page=" + annpage,
                type: "GET",
                dataType: "json",
                headers: {
                    "Authorization": "Bearer " + token
